  ...
  const organizations: Organization[] = [
    {
      ...
      establishedYear: 2015, animalHandling: '第一種動物取扱業（登録）', animalTypes: ['DOG', 'CAT'],
      memberCount: 8, volunteerCount: 45, avgAnimalsManaged: 70,
      partnerMunicipalities: '東京都、世田谷区', hasPartnerOrgs: true,
      activities: ['保護・譲渡', 'TNR活動', '一時預かり（フォスター）', '普及啓発・教育'],
    },
    {
      ...
      memberCount: 4, volunteerCount: 22, avgAnimalsManaged: 52,
      partnerMunicipalities: '横浜市', hasPartnerOrgs: true,
      activities: ['保護・譲渡', 'TNR活動', '多頭飼育崩壊対応'],
    },
    {
      ...
      establishedYear: 2012, animalHandling: '登録・届出なし', animalTypes: ['DOG', 'CAT'],
      memberCount: 6, volunteerCount: 30, avgAnimalsManaged: 40,
      partnerMunicipalities: '大阪府、大阪市、堺市', hasPartnerOrgs: false,
      activities: ['保護・譲渡', '医療・ケア', '行政連携'],
    },
    {
      ...
      memberCount: 1, volunteerCount: 5, avgAnimalsManaged: 12,
      partnerMunicipalities: '札幌市', hasPartnerOrgs: false,
      activities: ['保護・譲渡', '災害時対応'],
    },
    {
      ...
      memberCount: 5, volunteerCount: 18, avgAnimalsManaged: 25,
      partnerMunicipalities: '福岡県、福岡市', hasPartnerOrgs: true,
      activities: ['保護・譲渡', '一時預かり（フォスター）', '普及啓発・教育'],
    },
  ];
