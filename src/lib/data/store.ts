...
function seed(): DB {
  ...
  const organizations: Organization[] = [
    { id: 'org_1', name: 'あおぞら動物保護ネット', prefectureCode: pref('13'), orgType: 'NPO法人', contactName: '山田 花子', contactEmail: 'aozora@example.org', isActive: true, notes: null },
    { id: 'org_2', name: 'にゃんこハウス神奈川', prefectureCode: pref('14'), orgType: '一般社団法人', contactName: '佐藤 太郎', contactEmail: 'nyanko@example.org', isActive: true, notes: null },
    { id: 'org_3', name: 'いぬねこ里親会おおさか', prefectureCode: pref('27'), orgType: '任意団体', contactName: '田中 美咲', contactEmail: null, isActive: true, notes: null },
    { id: 'org_4', name: '北の動物ボランティア', prefectureCode: pref('01'), orgType: '個人活動者', contactName: '鈴木 一郎', contactEmail: null, isActive: true, notes: null },
    { id: 'org_5', name: 'ふくおか保護犬の家', prefectureCode: pref('40'), orgType: 'NPO法人', contactName: '高橋 結衣', contactEmail: 'fukuoka@example.org', isActive: true, notes: null },
  ];
